...
const resortData = [
  ...
  },
  {
    ...
    resort_content:
      "With over 8,400 acres and 150 trails, Powder Mountain is considered the largest ski resort in the entire nation! Skiiers and snowboarders alike enjoy these vast mountain ranges with little congregation from others.",
    annual_snowfall: "Annual snowfall: 350 inches",
  },
  {
    resort_title: "Brighton",
    resort_content:
      "Brighton is most known for their incredibly high quality snow. It is located in Big Cottonwood Canyon, and it was the first ski resort opened in Utah!",
    annual_snowfall: "Annual snowfall: 500 inches",
  },
  {
